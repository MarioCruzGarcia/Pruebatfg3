...
import {
  DomSanitizer
} from "./chunk-P3TZK6WI.js";
import "./chunk-EPSCBQ4P.js";
import {
  CommonModule,
  DOCUMENT,
  NgIf
} from "./chunk-W2IXXRYQ.js";
import {
  ApplicationRef,
  Component,
...
ToastContainerModule.ɵmod = ɵɵdefineNgModule({
  type: ToastContainerModule,
  declarations: [ToastContainerDirective],
  exports: [ToastContainerDirective]
});
ToastContainerModule.ɵinj = ɵɵdefineInjector({});
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ToastContainerModule, [{
    type: NgModule,
    args: [{
      declarations: [ToastContainerDirective],
      exports: [ToastContainerDirective]
...
OverlayContainer.ɵfac = function OverlayContainer_Factory(t) {
  return new (t || OverlayContainer)(ɵɵinject(DOCUMENT));
};
...
Overlay.ɵfac = function Overlay_Factory(t) {
  return new (t || Overlay)(ɵɵinject(OverlayContainer), ɵɵinject(ComponentFactoryResolver$1), ɵɵinject(ApplicationRef), ɵɵinject(DOCUMENT));
};
